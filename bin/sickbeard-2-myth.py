...
TV_PATH="/mnt/media/video/Television/"
BACKEND_HOST='192.168.1.145'
BACKEND_USER='mythtv'
BACKEND_PASS='cTgdl1Mndb+cdVCJ' # can often be found in /etc/mythtv/config.xml
LOG_PATH='/var/log/sickbeard-2-myth.log'
...
try:
    ...
    logger.debug("Error %s : %s : %s" % (exc_type, fname, exc_tb.tb_lineno))
    print "Error %s" % (str(e))
    sys.exit(1)
